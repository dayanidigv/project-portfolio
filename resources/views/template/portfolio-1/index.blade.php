                      ...
                      <div class="expertise-main mt-24">
                        <div class="row g-3">
                          ...
                          <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                            <div class="expertise-item">
                              <div class="image text-center">
                                <img src="img/icons/notion.svg" alt="notion">
                              </div>
                              <div class="text">
                          ...
                          <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                            <div class="expertise-item">
                              <div class="image text-center">
                                <img src="img/icons/mico.svg" alt="micro">
                              </div>
                              <div class="text">
                          ...
                          <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                            <div class="expertise-item">
                              <div class="image text-center">
                                <img src="img/icons/framer.svg" alt="framer">
                              </div>
                              <div class="text">
                          ...
                          <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                            <div class="expertise-item">
                              <div class="image text-center">
                                <img src="img/icons/webflow.svg" alt="webflow">
                              </div>
                              <div class="text">
                          ...
                          <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                            <div class="expertise-item">
                              <div class="image text-center">
                                <img src="img/icons/zeplin.svg" alt="zeplin">
                              </div>
                              <div class="text">
                    ...
                    <div class="row g-4 parent-container">
                      <div class="col-lg-12">
                        <div class="project-item">
                          <div class="image">
                            <img src="img/projects/project-1.png" alt="project-1" class="img-fluid w-100">
                            <a href="img/projects/project-1.png"
                      ...
                      <div class="col-lg-12">
                        <div class="project-item">
                          <div class="image">
                            <img src="img/projects/project-2.png" alt="project-2" class="img-fluid w-100">
                            <a href="img/projects/project-2.png"
                              class="gallery-popup full-image-preview parent-container">
                              <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none"
                                stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                                <path d="M10 4.167v11.666M4.167 10h11.666"></path>
